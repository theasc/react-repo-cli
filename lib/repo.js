...
module.exports = {
  ...
  createGitignore: async () => {
    ...
    if (filelist.length) {
      ...
      if (answers.ignore.length) {
        ...
        console.log('created write gitignore');
      } else {
        touch( '.gitignore' );
        console.log('created gitignore 1');
      }
    } else {
      touch('.gitignore');
      console.log('created gitignore 2');
    }
  },
  setupRepo: async (url, projectName) => {
  ...
  generateRepository: async (projectName = './') => {
    try {
      ...
      await module.exports.setupRepo(url, projectName);
